    ...
    return (
      <div className="max-w-xl mx-auto mt-10 p-8 bg-white border border-line rounded-xl shadow-sm text-center">
        ...
        <p className="text-slate-600 mb-6">
          Yêu cầu đăng ký BHYT của sinh viên đã được ghi nhận. Phòng CTSV sẽ
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className={ui.card}>
          <div className={ui.cardHeader}>
            <h2 className={ui.sectionTitle}>
              <CreditCard size={16} className="text-primary" /> Thanh toán & Hồ
              sơ
            </h2>
          </div>
          <div className="p-5 space-y-6">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button type="submit" disabled={saving} className={ui.btnPrimary}>
            {saving ? <Loader2 size={16} className="animate-spin" /> : null} Gửi
            đăng ký
          </button>
        </div>
      </form>
